...
- **Scenario 2: SMP Performance Analysis**
    - **User** runs the Dining Philosophers Sample on Cluster 1.
    - **System** utilizes all 4 cores in Cluster 1 to simulate concurrent resource contention.
    - **User** observes deadlock-free execution and thread scheduling across cores.
...
- **Workloads**:
    ...
    - **Verification**: Zephyr Dining Philosophers Sample (`samples/philosophers`) on Cluster 1.
